<template>
  <div class="wrapper">
    ...
    <Upgrade cost="100" add-amount="2" label="Upgrade 2" efficiency-cost="20000"></Upgrade>
    <Upgrade cost="1000" add-amount="20" label="Upgrade 3" efficiency-cost="50000"></Upgrade>
